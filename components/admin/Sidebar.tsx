          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive
                  ? "neu-inset bg-white/20 text-primary shadow-neu-lg"
                  : "text-neutral-700 hover:bg-white/10 hover:text-primary"
              )}
            >
              <div className={cn(
                ...
                <Icon className={cn(
                  ...
                  isActive ? "text-primary" : "text-neutral-600 group-hover:text-primary"
                )} />
              </div>
              <span className="font-semibold font-body">{item.name}</span>
              {isActive && (
                <div className="absolute right-4 w-1.5 h-8 bg-primary rounded-full shadow-premium"></div>
              )}
            </Link>
          );
        })}
