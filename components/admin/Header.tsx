        ...
        <div className="flex items-center justify-between px-6 py-3 h-16">
          ...
          <div className="flex items-center gap-4">
            ...
            <button className="relative p-2 glass rounded-premium hover:bg-white/35 transition-all group h-10 w-10 flex items-center justify-center">
              <Bell className="w-4 h-4 text-neutral-700 group-hover:text-primary-600 transition-colors" />
              <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-primary-500 rounded-full ring-2 ring-white shadow-sm"></span>
            </button>
            ...
            <div className="relative">
              ...
              >
                ...
                <ChevronDown className="w-3 h-3 text-neutral-500 hidden md:block group-hover:text-primary-600 transition-colors" />
              </button>
