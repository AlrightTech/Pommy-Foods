        ...
        <div className="flex items-center justify-between px-6 py-3 h-16">
          <div className="flex items-center gap-4">
            ...
            <div className="md:hidden flex items-center gap-3">
              ...
              <span className="font-bold font-body text-lg text-[#D2AC6A] hover:text-[#B8944F] active:text-[#9A7A3F] transition-colors">Pommy Foods</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden md:flex items-center gap-2 glass rounded-premium px-3 py-2 h-10 min-w-[300px] focus-within:shadow-glass-lg focus-within:bg-white/35 transition-all">
              <Search className="w-4 h-4 text-[#D2AC6A] flex-shrink-0" />
              <input
                type="text"
            ...
            <button className="relative p-2 glass rounded-premium hover:bg-white/35 transition-all group h-10 w-10 flex items-center justify-center">
              <Bell className="w-4 h-4 text-neutral-700 group-hover:text-[#D2AC6A] transition-colors" />
              <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-[#D2AC6A] rounded-full ring-2 ring-white shadow-sm"></span>
            </button>
            ...
            <div className="relative">
              ...
              >
                ...
                <ChevronDown className="w-3 h-3 text-neutral-500 hidden md:block group-hover:text-[#D2AC6A] transition-colors" />
              </button>
